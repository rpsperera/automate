...
public interface CheckElementPresent<T> extends Command<T> {


    default boolean checkElementPresent(ElementIdentifier elementIdentifier, String element) throws AutomateException {
