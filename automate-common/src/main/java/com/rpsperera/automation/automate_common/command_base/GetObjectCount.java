...
public interface GetObjectCount<T> extends Command<T> {

    default int getObjectCount(ElementIdentifier elementIdentifier, String element) throws AutomateException {
