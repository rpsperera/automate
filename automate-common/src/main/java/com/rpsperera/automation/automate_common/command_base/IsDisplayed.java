...
public interface IsDisplayed<T> extends Command<T> {

    default Boolean isDisplayed(ElementIdentifier elementIdentifier, String element) throws AutomateException {
